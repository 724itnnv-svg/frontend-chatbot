...
export default function ForgotPassword() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      setSuccess(
        data.message ||
          "Nếu email tồn tại trong hệ thống, link đặt lại mật khẩu đã được gửi về Gmail. Vui lòng kiểm tra Inbox/Spam rồi bấm vào link để tạo mật khẩu mới."
      );
    } catch (err) {
      console.error(err);
            ...
            <div className="p-6 pb-4">
              <div className="flex items-start gap-3">
                ...
                <div className="min-w-0">
                  <h1 className="text-xl font-semibold tracking-tight text-slate-900">Quên mật khẩu</h1>
                  <p className="mt-1 text-sm text-slate-500">
                    Nhập Gmail hoặc phần trước @gmail.com để nhận link tạo mật khẩu mới.
                  </p>
                </div>
              </div>
            </div>
