...
const MENU_GROUPS = [
  ...
  },
  {
    ...
    label: "Hệ thống & AI",
    icon: ShieldCheck,
    items: ["admin_dashboard", "admin_products_tool", "admin_vectorstore_tool", "admin_agent", "admin_agent_promo", "admin_agent_response_templates", "admin_chatbot_config", "admin_chat_v3_faq", "admin_testcase", "admin_logs", "notifications"],
  },
  {
    id: "experimental",
